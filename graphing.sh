...
mosquitto_pub -t openWB/graph/lastlivevalues -r -m "$(date +%H:%M:%S),$uberschuss,$ladeleistung,$pvgraph,$ladeleistunglp1,$ladeleistunglp2,$ladeleistung,$speicherleistung,$speichersoc,$soc,$soc1,$hausverbrauch,$verbraucher1_watt,$verbraucher2_watt,$ladeleistunglp3,$ladeleistunglp4,$ladeleistunglp5,$bezugw1,$bezugw2,$bezugw3,$pvgraph1,$pvgraph2,$pvgraph3" &
