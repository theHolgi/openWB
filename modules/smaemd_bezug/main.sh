...
ikwh=$(cat /run/shm/em-$smaemdbezugid-pconsumecounter)
ekwh=$(cat /run/shm/em-$smaemdbezugid-psupplycounter)
bezuga1=$(cat /run/shm/em-$smaemdbezugid-p1consume |sed 's/\..*$//')
bezuga2=$(cat /run/shm/em-$smaemdbezugid-p2consume |sed 's/\..*$//')
bezuga3=$(cat /run/shm/em-$smaemdbezugid-p3consume |sed 's/\..*$//')
wattbezug=$(cat /run/shm/em-$smaemdbezugid-pconsume |sed 's/\..*$//')
watteinspeisung=$(cat /run/shm/em-$smaemdbezugid-psupply |sed 's/\..*$//')
