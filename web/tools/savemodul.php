...
if(isset($_POST['evsecon'])) {
	...
	foreach($lines as $line) {
		...
		if(strpos($line, "soc_teslalp2_carnumber=") !== false) {
			$result .= 'soc_teslalp2_carnumber='.$_POST['teslasoclp2carnumber']."\n";
			$writeit = '1';
		}
	...
	$i3soc = $_SERVER['DOCUMENT_ROOT']."/openWB/modules/soc_i3/auth.json";
	$i3soc = fopen($i3soc, 'w');
	...
	$i3soc1 = $_SERVER['DOCUMENT_ROOT']."/openWB/modules/soc_i3s1/auth.json";
