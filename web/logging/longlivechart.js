...
function loadgraph() {
	...
	alph1 = convertToKw(getCol(csvData, 9));
	alph2 = convertToKw(getCol(csvData, 10));
	alph3 = convertToKw(getCol(csvData, 11));
	...
	visibility(alph1,'hidelp6','Ph1',boolDisplayLp6);
	visibility(alph2,'hidelp7','Ph2',boolDisplayLp7);
	visibility(alph3,'hidelp8','Ph3',boolDisplayLp8);
